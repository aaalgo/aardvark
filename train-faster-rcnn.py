...
class Model (FasterRCNN):
    ...
    def build_backbone (self):
        self.backbone = aardvark.create_stock_slim_network(FLAGS.backbone, self.images, self.is_training, global_pool=False, stride=FLAGS.backbone_stride, scope='fuck1')
